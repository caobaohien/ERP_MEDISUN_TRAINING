...
public final class MuaHang_005fHuy_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ResultSet dataListncc = (ResultSet)obj.getDataListNCC(); 
 ...
 obj.setNextSplittings(); 
      ...
      out.write("\t {   \r\n");
      out.write("\t\t \r\n");
      out.write("\t\tdocument.forms[\"erpDmhForm\"].action.value = \"new\";\r\n");
      out.write("\t    document.forms[\"erpDmhForm\"].submit();\r\n");
      out.write("\t }\r\n");
      ...
      out.write("\t {   \r\n");
      out.write("\t\tdocument.forms[\"erpDmhForm\"].action.value = \"print_pdf\";\r\n");
      out.write("\t    document.forms[\"erpDmhForm\"].submit();\r\n");
      out.write("\t }\r\n");
      out.write("\t function clearform()\r\n");
      out.write("\t {   \r\n");
      out.write("\t\t \r\n");
      out.write("\t\tdocument.forms[\"erpDmhForm\"].action.value = \"clear\";\r\n");
      out.write("\t    document.forms[\"erpDmhForm\"].submit();\r\n");
      out.write("\t } \r\n");
      ...
      out.write("\t     \talert(\"THONG BAO LOI nay\"+document.forms[\"erpDmhForm\"].msg.value);\r\n");
      out.write("\t }\r\n");
      out.write("\t \r\n");
      out.write("\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t<form name=\"erpDmhForm\" method=\"post\" action=\"../../MuaHangSvl\">\r\n");
      ...
      out.write("\t\t\t\t\tclass=\"tbnavigation\">Danh sách don mua hang</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\ttitle=\"Them moi\" alt=\"Tìm kiếm\" border=\"1px\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\ttitle=\"In báo cáo\" alt=\"In báo cáo\" border=\"1px\"\r\n");
      ...
      out.write("\t\t\t\t\t<fieldset>\r\n");
      out.write("\t\t\t\t\t\t<legend>\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"legendtitle\"> don hang mua </span>&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t</legend>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TD class=\"plainlabel\">Mã Mua Hang</TD>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TD class=\"plainlabel\"><input type=\"text\" name=\"mamh\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"width: 200px\" onchange=\"submitform()\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(obj.getmamh());
      out.write("\"></TD>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</TR>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TD class=\"plainlabel\">Tên NCC</TD>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"plainlabel\"><select name=\"tenncc\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tonchange=\"submitform()\" style=\"width: 200px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"\"></option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
...
{ 
      ...
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"10%\">Mã Mua hang</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"15\">Ngay</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"25\">Nha Cung Cap</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"10%\">Trạng thái</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"10%\">Tong tien</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"10%\">Ngay tao</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"10%\">Nguoi tao</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"15%\">Tác vụ</TH>\r\n");
      out.write("\t\t\t\t\t\t\t</TR>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.print( dataList.getString("MUAHANG_FK") );
      out.write("</TD>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TD align=\"center\">");
...
String tt = dataList.getString("TRANGTHAI");
      ...
      out.write("\t\t\t\t\t\t\t\t</TD>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TD align=\"center\">");
      out.print(dataList.getFloat("TONGTIEN"));
      out.write("</TD>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TD align=\"center\">");
      ...
      out.write("\t\t\t\t\t\t\t\t\thref=\"../../MuaHangNewSvl?userId=");
      out.print(userId);
      out.write("&display=");
      out.print( dataList.getString("MUAHANG_FK") );
      out.write("\"><IMG\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tsrc=\"../images/Display20.png\" alt=\"Hiển thị\" title=\"Hiển thị\"\r\n");
 ...
 if(tt.equals("0")){ 
      ...
      out.write("\t\t\t\t\t\t\t\t</A>&nbsp; <A\r\n");
      out.write("\t\t\t\t\t\t\t\t\thref=\"../../MuaHangSvl?userId=");
      out.print(userId);
      out.write("&chot=");
      out.print( dataList.getString("MUAHANG_FK") );
      out.write("\"><img\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tsrc=\"../images/Chot.png\" width=\"20\" height=\"20\" border=0\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\talt=\"chot Quản lý mua hàng\" title=\"chot Quản lý mua hàng\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tonclick=\"if(!confirm('Bạn có muốn chot đơn mua hàng này?')) return false;\"></A>&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<A\r\n");
      out.write("\t\t\t\t\t\t\t\t\thref=\"../../MuaHangSvl?userId=");
      out.print(userId);
      out.write("&delete=");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tborder=0 alt=\"Xóa Quản lý mua hàng\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttitle=\"Xóa Quản lý mua hàng\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tonclick=\"if(!confirm('Bạn có muốn xóa đơn mua hàng này?')) return false;\"></A>&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
} 
      out.write("</TD>\r\n");
      out.write("\t\t\t\t\t\t\t</TR>\r\n");
