...
public final class BanhangList_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 obj.setNextSplittings(); 
      ...
      out.write("\t\t\t\t\tclass=\"tbnavigation\">Bảng kê bán hàng</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"7%\">Mã ĐH</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"300px\">Ngày</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"12%\">Khách hàng</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"7%\">Trạng thái</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"7%\">Tổng tiền</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"7%\">Ngày tạo</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"10%\">Người tạo</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"9%\">Tác vụ</TH>\r\n");
      out.write("\t\t\t\t\t\t\t</TR>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
...
String tt = dmhList.getString("trangthai");
 ...
 if(tt.equals("0")){ 
      ...
      out.print(dmhList.getString("sochungtu"));
      out.write("'\r\n");
      out.write("\t\t\t\t\t\t\t\t\thref=\"\"><img src=\"../images/Chot.png\" alt=\"Chốt\" width=\"20\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\theight=\"20\" title=\"Chốt\" border=\"0\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tonclick=\"if(!confirm('Bạn có muốn chốt đơn hàng này?')) {return false ;}else{ processing('");
