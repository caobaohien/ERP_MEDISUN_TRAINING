...
public final class Nhacungcaplist_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 obj.setNextSplittings(); 
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t<form name=\"erpDmhForm\" method=\"post\" action=\"../../NhacungcapSvl\">\r\n");
      ...
      out.write("\t\t\t\t\tclass=\"tbnavigation\">Danh sách khách hàng</div>\r\n");
      ...
      out.write("\t\t\t\t\t<fieldset>\r\n");
      out.write("\t\t\t\t\t\t<legend>\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"legendtitle\"> Khách hàng </span>&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t</legend>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TD class=\"plainlabel\">Mã/Tên</TD>\r\n");
...
String tt = dataList.getString("trangthai");
      ...
      out.write("\t\t\t\t\t\t\t\t\thref=\"../../NhacungcapNewSvl?userId=");
      out.print(userId);
      out.write("&update=");
      out.print( dataList.getString("sochungtu"));
      out.write("\">\r\n");
