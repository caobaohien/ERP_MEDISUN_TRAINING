...
public final class DonbanhangList_005fcuong_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ResultSet RsKH= (ResultSet)obj.getRsKhachHang();
 ...
 obj.setNextSplittings(); 
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t<form name=\"donhang\" method=\"post\"\r\n");
      out.write("\t\taction=\"../../DonbanhangListSvl_cuong\">\r\n");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th><a\r\n");
      out.write("\t\t\t\t\t\t\t\t\thref=\"../../DonbanhangSvl_cuong?userId=");
      out.print(userId);
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t&update=");
      out.print(datalist.getString("pk_seq"));
