...
public final class Sanphamnewnhom2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	ResultSet rsdvt=nccBean.getRsDvt();
      ...
      out.write("\t\t\t\t\tclass=\"tbnavigation\">Thong tin sanpham</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(nccBean.getTen());
      out.write("\"></TD>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</TR>\r\n");
      out.write("\t\t\t\t\t\t\t<TR>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TD class=\"plainlabel\">Donvi</TD>\r\n");
...
if(rsdvt!=null) {
      ...
      out.print(rsdvt.getString("pk_seq"));
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tselected=\"selected\">");
      out.print(rsdvt.getString("ma") );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
 ...
 if(nccBean.getTrangthai().equals("1")) {
      out.write(" <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttype=\"checkbox\" name=\"tinhtrang\" checked=\"checked\" value=\"1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
}else {
