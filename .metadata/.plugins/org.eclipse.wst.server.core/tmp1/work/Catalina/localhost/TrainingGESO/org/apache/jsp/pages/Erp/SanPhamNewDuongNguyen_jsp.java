...
public final class SanPhamNewDuongNguyen_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	ResultSet rsDonViTinh = spBean.getRsDonViTinh();
      ...
      out.write("\t\tdocument.forms['spFormDN'].action.value = 'save';\r\n");
      out.write("\t\tdocument.forms['spFormDN'].submit();\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tdocument.forms['spFormDN'].action.value = 'submit';\r\n");
      out.write("\t\tdocument.forms[\"spFormDN\"].submit();\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction themmoi() {\r\n");
      out.write("\t\tdocument.forms['spFormDN'].action.value = 'themmoi';\r\n");
      out.write("\t\tdocument.forms['spFormDN'].IsCapNhat.value = '1';\r\n");
      out.write("\t\tdocument.forms[\"spFormDN\"].submit();\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction quaylaiInit() {\r\n");
      out.write("\t\tdocument.forms['spFormDN'].action.value = 'quaylaiInit';\r\n");
      out.write("\t\tdocument.forms['spFormDN'].IsCapNhat.value = '0';\r\n");
      out.write("\t\tdocument.forms[\"spFormDN\"].submit();\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction savekhachhang() {\r\n");
      out.write("\t\tdocument.forms['spFormDN'].action.value = 'savekhachhang';\r\n");
      out.write("\t\tdocument.forms['spFormDN'].IsCapNhat.value = '0';\r\n");
      out.write("\t\tdocument.forms[\"spFormDN\"].submit();\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction Chinhsua() {\r\n");
      out.write("\t\tdocument.forms['spFormDN'].action.value = 'chinhsua';\r\n");
      out.write("\t\tdocument.forms['spFormDN'].IsCapNhat.value = '0';\r\n");
      out.write("\t\tvar id_dh = document.forms['spFormDN'].id_dh.value;\r\n");
      out.write("\t\tif (id_dh == \"\") {\r\n");
      ...
      out.write("\t<form name=\"spFormDN\" method=\"post\"\r\n");
      out.write("\t\taction=\"../../SanPhamDuongNguyenNewSvl\">\r\n");
      out.write("\t\t<input type=\"hidden\" name=\"userId\" value='");
      out.print(userId);
      out.write("'> <input\r\n");
      out.write("\t\t\ttype=\"hidden\" name=\"action\" value=\"1\" /> <input type=\"hidden\"\r\n");
      out.write("\t\t\tname=\"id\" value='");
      out.print(spBean.getId());
      out.write("'>\r\n");
      ...
      out.write("\t\t\t\t\tclass=\"tbnavigation\">Thong tin sản phẩm</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\thref=\"../../SanphamListSvl?userId=");
      out.print(userId);
      out.write("\"> <IMG\r\n");
      ...
      out.print(spBean.getMsg());
      out.write("</textarea>\r\n");
      out.write("\t\t\t\t</fieldset>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div align=\"left\" style=\"width: 100%; float: none; clear: left\">\r\n");
      out.write("\t\t\t\t<fieldset>\r\n");
      out.write("\t\t\t\t\t<legend class=\"legendtitle\"> Thêm sản phẩm </legend>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(spBean.getTen());
      out.write("\"></TD>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</TR>\r\n");
      out.write("\t\t\t\t\t\t\t<TR>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TD class=\"plainlabel\">Đơn vi</TD>\r\n");
      ...
      out.print(rsDonViTinh.getString("ma"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write(" <input type=\"checkbox\" name=\"tinhTrang\" checked=\"checked\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"1\"> ");

 	} else {
 
      out.write(" <input type=\"checkbox\" name=\"tinhTrang\" value=\"1\"> ");
