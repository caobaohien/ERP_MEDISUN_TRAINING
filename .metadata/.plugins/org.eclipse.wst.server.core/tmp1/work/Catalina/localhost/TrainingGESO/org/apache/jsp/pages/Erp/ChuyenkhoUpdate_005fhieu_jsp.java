...
public final class ChuyenkhoUpdate_005fhieu_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	ResultSet dataListck1 = (ResultSet) obj.getRsck1();
      ...
      out.write("<script type=\"text/javascript\" src=\"../scripts/erp-spList_hieu.js\"></script>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\taction=\"../../ChuyenkhoUpdateSvl_hieu\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\talign=\"left\"><A href=\"javascript:print_excel()\"> <IMG\r\n");
      out.write("\t\t\t\t\t\t\t\tsrc=\"../images/Excel.jpg\" title=\"Xuất chứng từ\"\r\n");
      ...
      out.write("\t\t\t\t\t\t<td ");
 							...
 							if (obj.getId().length()>0) {
      out.write(" width=\"30px\"\r\n");
      out.write("\t\t\t\t\t\t\talign=\"left\"><A href=\"javascript:print_pdf()\"> <IMG\r\n");
      out.write("\t\t\t\t\t\t\t\tsrc=\"../images/pdf.jpg\" title=\"Xuất chứng từ\"\r\n");
      out.write("\t\t\t\t\t\t\t\talt=\"Xuất chứng từ\" border=\"1px\"\r\n");
      out.write("\t\t\t\t\t\t\t\tstyle=\"border-style: outset; width: 30px; height: 30px\">\r\n");
      out.write("\t\t\t\t\t\t</A> ");
 } 
      ...
      out.print(obj.getNgaychuyenkho());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</TD>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</TR>\r\n");
