...
public final class DonbanhangList_005fTan_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 obj.setNextSplittings(); 
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t<form name=\"erpDmhForm\" method=\"post\" action=\"../../DonhangListSvl_tan\">\r\n");
...
String tt = dataList.getString("Trangthai");
      ...
      out.write("\t\t\t\t\t\t\t\t</TD>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TD align=\"center\">");
      out.print( dataList.getString("TongtientruocVAT") );
      out.write("</TD>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TD align=\"center\">");
 ...
 if(tt.equals("0")){ 
      out.write(" <A\r\n");
      out.write("\t\t\t\t\t\t\t\t\thref=\"../../DonhangNewSvl_tan?userId=");
      out.print(userId);
      out.write("&update=");
      out.print( dataList.getString("MaDH"));
      out.write("\">\r\n");
