...
public final class DonBanHangUpdate_005fHang_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String action = (String) session.getAttribute("action");
      ...
      out.write("<script type=\"text/javascript\" src=\"../scripts/erp_ListSanPham_Hang.js\"></script>\r\n");
      ...
      out.write("\t\t\t\t\tvar slgton = soluongton.item(i).value.replace(/,/g,\"\"); \r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tif(pos > 0)\r\n");
      out.write("\t\t\t\t\t{\r\n");
      ...
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t//Sau khi cắt xong tự động chuyển qua tab Số Lượng\r\n");
      out.write("\t\t\t\t\t\tsoluong.item(i).focus();\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t//nếu soluong khác rỗng thì tính thành tiền và đơn giá luôn\r\n");
      ...
      out.write("\t\t\t \r\n");
      out.write("\t\t\tvar soluong = document.getElementsByName(\"soLuong\");\r\n");
      out.write("\t\t\tvar dongia = document.getElementsByName(\"donDia\");\r\n");
      out.write("\t\t\tvar thanhtien = document.getElementsByName(\"thanhTien\");\t\t\t\t\r\n");
      ...
      out.write("\t\taction=\"../../DonBanHangUpdate_HangSvl\">\r\n");
...
int i = 0; 
      ...
      out.print( i + 1 );
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"text-align: center;\" readonly=\"readonly\"> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttype=\"hidden\" name=\"idsp\" value=\"");
      out.print(sp.getIdSanPham());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"maSanPham\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(sp.getMaSanPham());
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tonkeyup=\"ajax_showOptions(this,'donmuahang',event)\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tAUTOCOMPLETE=\"off\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"tenSanPham\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(sp.getTenSanPham());
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"donViTinh\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(sp.getDonViTinh());
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"soLuong\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(sp.getSoLuong());
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"soLuongTon\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(sp.getSoLuongTon());
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"donGia\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(sp.getDonGia());
      out.write("\" readonly=\"readonly\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"thanhTien\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"");
      ...
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"text-align: center;\" readonly=\"readonly\"> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttype=\"hidden\" name=\"idsp\" value=\"\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"maSanPham\" value=\"\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tonkeyup=\"ajax_showOptions(this,'donmuahang',event)\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tAUTOCOMPLETE=\"off\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"tenSanPham\" value=\"\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"donViTinh\" value=\"\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"soLuong\" value=\"\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"soLuongTon\" value=\"\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"donGia\" value=\" \"\r\n");
      out.write("\t\t\t\t\t\t\t\t\treadonly=\"readonly\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"thanhTien\" value=\" \"\r\n");
      out.write("\t\t\t\t\t\t\t\t\treadonly=\"readonly\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</TR>\r\n");
      out.write("\t\t\t\t\t\t\t");
