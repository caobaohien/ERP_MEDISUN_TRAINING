...
public final class DonmuahangList_005ftan_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 obj.setNextSplittings(); 
      ...
      out.write("\t\taction=\"../../DonmuahangListSvl_tan\">\r\n");
      ...
      out.write("\t\t\t\t\tclass=\"tbnavigation\">Danh sách ĐƠN MUA HÀNG</div>\r\n");
      ...
      out.write("\t\t\t\t\t<fieldset>\r\n");
      out.write("\t\t\t\t\t\t<legend>\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"legendtitle\"> ĐƠN MUA HÀNG </span>&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t</legend>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TD class=\"plainlabel\">Mã MH</TD>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TD class=\"plainlabel\"><input type=\"text\" name=\"txtMaMH\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"width: 200px\" onchange=\"submitform()\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(obj.getMamuahang());
      out.write("\"></TD>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(listKH.getString("NHACUNGCAP"));
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write(" <select name=\"cbTrangthai\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tonchange=\"submitform()\" style=\"width: 200px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"\"></option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"5%\">MÃ MH</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"8%\">NGÀY CHỨNG TỪ</TH>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TH align=\"center\" width=\"10%\">NHÀ CUNG CẤP</TH>\r\n");
      ...
      out.print( dataList.getString("MAMH") );
      out.write("</TD>\r\n");
      out.write("\t\t\t\t\t\t\t\t<TD align=\"center\">");
...
String tt = dataList.getString("TRANGTHAI");
      ...
      out.write("\t\t\t\t\t\t\t\t\thref=\"../../DonmuahangNewSvl_tan?userId=");
      out.print(userId);
      out.write("&display=");
      out.print( dataList.getString("MaMH") );
      out.write("\">\r\n");
 ...
 if(tt.equals("0") || tt.equals("1")){ 
      ...
      out.print("chotphieu"+dataList.getString("MaMH"));
      out.write("', \r\n");
      out.write("                                \t\t\t\t\t\t'../../DonmuahangListSvl_tan?userId=");
      out.print(userId);
      out.write("&chot=");
      out.print( dataList.getString("MaMH"));
      out.write("');\r\n");
