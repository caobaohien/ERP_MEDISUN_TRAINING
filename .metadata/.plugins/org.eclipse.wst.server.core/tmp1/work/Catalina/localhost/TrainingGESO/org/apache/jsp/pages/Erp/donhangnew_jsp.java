...
public final class donhangnew_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	Utility util = new Utility();
      ...
      out.write("\t\t\tdocument.getElementById(\"khId\").value=tmp.substring(0,parseInt(tem.indexOf(\"-\")));\r\n");
      out.write("\t\t\tsmartId.item(0).value=tmp.substring(parseInt(tem.indexOf(\"-\"))+1,tmp.length);\r\n");
      ...
      out.write("\t\t\twhile(sp.match(\",\")){\r\n");
      out.write("\t\t\t\tsp=sp.replace(\",\",\"\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif(parseInt(sp.indexOf(\"-->\"))>0){\r\n");
      out.write("\t\t\t\tvar tmp=sp.substring(0,parseInt(sp.indexOf(\"-->\")));\r\n");
      out.write("\t\t\t\tdocument.getElementById(\"spId\").value=tmp.substring(parseInt(tmp.indexOf(\"-\"))+1,tmp.length);\r\n");
      out.write("\t\t\t\tmasp.item(i).value=tmp.substring(0,parseInt(tmp.indexOf(\"-\")));\r\n");
      out.write("\t\t\t\t//idsp.item(i).value=tmp.substring(parseInt(tem.indexOf(\"-\"))+1, tmp.length);\r\n");
      ...
      out.write("\tdocument.forms[\"donhanglist\"].action.value=\"luumoi\";\r\n");
      out.write("\tdocument.forms[\"donhanglist\"].submit();\r\n");
      out.write("}\r\n");
      out.write("function savekhachhang()\r\n");
      out.write("{ \t\t\r\n");
      out.write("\tdocument.forms[\"donhanglist\"].action.value=\"savekhachhang\";\r\n");
      out.write("    document.forms[\"donhanglist\"].submit();\r\n");
      out.write("}\r\n");
      ...
      out.print(obj.getTongtientruocVat());
      ...
      out.print(obj.getTongtiensauVat());
      out.write("\"readonly>VND</td>\r\n");
      ...
      out.print(listSp.get(j).getPK_SEQ() );
      ...
      out.print(listSp.get(j).getMaSP() );
      out.write("\"onkeyup=\"ajax_showOptions(this,'donhang',event)\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tautocomplete=\"off\"style=\"width:100%\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"left\"width=\"15%\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\"name=\"tensp1\"id=\"tensp1\"value=\"");
      out.print(listSp.get(j).getTenSP() );
      out.write("\"\r\n");
      ...
      out.print(listSp.get(j).getSoLuong() );
      out.write("\"\r\n");
      ...
      out.print(listSp.get(j).getDonGia() );
      out.write("\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"left\"width=\"8%\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\"name=\"masp\"id=\"masp\"value=\"\"onkeyup=\"ajax_showOptions(this,'donhang',event)\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tautocomplete=\"off\"style=\"width:100%\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"left\"width=\"15%\">\r\n");
